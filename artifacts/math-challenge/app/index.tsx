...
function createStyles(colors: ReturnType<typeof useColors>) {
  return StyleSheet.create({
    ...
    operationCard: { width: '48.6%', minHeight: 66, borderRadius: 14, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.card, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 8 },
    operationCardSelected: { borderColor: colors.primary, backgroundColor: colors.secondary },
    operationIcon: { width: 32, height: 32, borderRadius: 10, backgroundColor: colors.muted, alignItems: 'center', justifyContent: 'center' },
    ...
    levelButton: { flex: 1, minHeight: 58, borderRadius: 13, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.card, alignItems: 'center', justifyContent: 'center' },
    levelButtonSelected: { borderColor: colors.primary, backgroundColor: colors.primary },
    levelNumber: { color: colors.foreground, fontFamily: 'Inter_700Bold', fontSize: 19 },
    ...
    primaryButton: { minHeight: 52, borderRadius: 15, backgroundColor: colors.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
