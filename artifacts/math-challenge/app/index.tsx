...
function createStyles(colors: ReturnType<typeof useColors>) {
  return StyleSheet.create({
    ...
    secondaryButton: { minHeight: 52, borderRadius: 15, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', marginTop: 10 },
    secondaryButtonText: { color: colors.foreground, fontFamily: 'Inter_600SemiBold', fontSize: 14 },
